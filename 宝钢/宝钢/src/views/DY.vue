<template>
  <div id="DYSQ" class="dysq">
    <div class="head">低压运行详情</div>
    <div class="row-a1">
      <div class="con">
        <div id="echart_1_1" class="echart"></div>
        <div class="tao">
          <div class="desc">
            <div class="txt">
              <div class="a1">低压总管压力:</div>
              <div class="a2">
                <div class="num">100</div>
                <div class="dan">Mp5</div>
              </div>
            </div>
            <div class="txt">
              <div class="a1">低压送汽温度:</div>
              <div class="a2">
                <div class="num">100</div>
                <div class="dan">℃</div>
              </div>
      ...
      <div class="con">
        <div id="echart_2_1" class="echart"></div>
        <div class="tao">
          <div class="desc">
            <div class="txt">
              <div class="a1">低压总管压力:</div>
      ...
      <div class="con">
        <div id="echart_3_1" class="echart"></div>
        <div class="tao">
          <div class="desc">
            <div class="txt">
              <div class="a1">低压总管总压力:</div>
              <div class="a2">
                <div class="num">100</div>
                <div class="dan">Mp5</div>
              </div>
      ...
      <div class="con">
        <div id="echart_1_2" class="echart"></div>
        <div class="tao">
          <div class="desc">
            <div class="txt">
              <div class="a1">低压总管压力:</div>
      ...
      <div class="con">
        <div id="echart_2_2" class="echart"></div>
        <div class="tao">
          <div class="desc">
            <div class="txt">
              <div class="a1">低压总管压力:</div>
      ...
      <div class="con">
        <div id="echart_3_2" class="echart"></div>
        <div class="tao">
          <div class="desc">
            <div class="txt">
              <div class="a1">低压总管总压力:</div>
...
export default {
  ...
  data() {
    return {
      ...
      sham: [
        {
          tab: [30, 35, 45, 40, 35, 40, 45, 55, 55, 60]
        },
        {
          tab: [30, 35, 45, 40, 35, 40, 45, 55, 55, 60]
        },
  ...
  methods: {
    liuliang() {
      for (let i = 0; i < 3; i++) {
        let tabtit = i + 1 + "号低压送汽表";
        let myChart = echarts.init(
          document.getElementById("echart_" + (i + 1) + "_1")
        );
        if (i == 2) tabtit = "低压送汽汇总表";
        myChart.setOption({
    ...
    yali() {
      for (let i = 0; i < 3; i++) {
        let tabtit = i + 1 + "号低压瞬时流量表";
        let myChart = echarts.init(
          document.getElementById("echart_" + (i + 1) + "_2")
        );
        if (i == 2) tabtit = "低压瞬时流量汇总表";
        myChart.setOption({
          backgroundColor: "rgba(0,0,0,0.5)",
          legend: {
            data: ["压力", "模拟压力"],
