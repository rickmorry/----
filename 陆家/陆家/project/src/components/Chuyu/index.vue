  ...
  color: #ffffff;">
      ...
      <div class="divchart one">
        <div class="panel bar1">
          <h2 style="text-align:left;">
            <a class="on" href="javascript:;">7日处理量(吨)</a>
      ...
      <div class="divchart two">
        <div class="panel bar2">
          <h2 style="text-align:left;">
            <a class="on" href="javascript:;" style="font-size:18px">7日社区收集量(吨)</a>
            <a href="javascript:;" style="font-size:16px">上月社区收集量(吨)</a>
          </h2>
          <div class="chart">图表</div>
          <div class="panel-footer"></div>
        </div>
      ...
      <div class="divchart three">
        <div class="panel pie">
          <h2 style="text-align:left;">
            <a class="on" href="javascript:;" style="font-size:14px">7日社区户均收集量对比</a>
            <a href="javascript:;" style="font-size:14px">上月社区户均收集量对比</a>
          </h2>
          <div class="chart">图表</div>
          <div class="panel-footer"></div>
        </div>
  ...
  methods: {
    ...
    table_2() {
      var yearData = [
        {
          year: "(吨)", //
          data: [[4, 7, 2.8, 3.0, 2.6, 2.7, 2.8, 3.8, 3.2]]
        },
        {
          year: "(吨)", //
