<template>
  <div class="container">
    ...
    <div class="pop community bounceIn">
      ...
      <div class="content">
        ...
        <div class="append camera">
          ...
          <div style="line-height:40px;text-align:center;font-size:18px;">双击全屏</div>
          <div id="playWind"></div>
          <div
            style="display: flex;
              flex-direction: row;
          ...
          <div class="taotaomenu" style="margin:10px auto;">
            <div style="display:none;" class="taotaobtn" id="previouspage">第一页</div>
            <div id="lookbtn" class="taotaobtn" style="display:none;" @click="zz">查看回放</div>
            <div style="display:none;" class="taotaobtn" id="nextpage">下一页</div>
          </div>
        </div>
        ...
        <div class="append chulichang">
          ...
          <div class="taotaomenu" style="margin:10px auto;">
            <div style="display:none;" class="taotaobtn" id="previouspa">第一页</div>
            <div id="lookbtn2" class="taotaobtn" style="display:none;" @click="zz">查看回放</div>
            <div style="display:none;" class="taotaobtn" id="nextpa">下一页</div>
          </div>
        </div>
    ...
    <div class="pops huifang" id="huifang">
      <div class="close" @click="closePops"></div>
      <div
        class="content"
        id="cont"
        style="display:flex;flex-direction:column;align-items: center;"
      >
        <select name id="selhuif" style="padding:5px 0;margin:5px auto;"></select>
        <div
          style="display:flex;  flex-direction: row;
  justify-content: flex-start;flex-wrap:wrap;
  align-items: center;width:100%;margin:5px auto;"
        >
          <div>
            开始时间
          ...
          <button id="startlook" style="font-size:12px;width:120px;height:35px;">开始查看</button>
        </div>

        <div id="huifvideo"></div>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async removeall(num) {
      await removePoints_tou(this.func);
      await removePoints_chu(this.func);
      await removePoints_zycl(this.func);
      await leixing(num);
