<template>
  <div class="container">
    ...
    <div class="current mainbox" style="position:relative">
      <div
        class="title"
        style="font-size:25px;font-weight:600;text-align:center;margin-bottom:10px;  position: absolute;
  top: 0px;
  left: 50%;
